...
{
    public class Game: IMovable, IMode, IGameInstance
    {
		...
		public bool IsBoardCoordinateOccupied(int x, int y) => _gameBoard.IsFreePos(x, y);
		...
		bool IGameInstance.GameOver => Status == GameStatus.Finished;

		public BlockType CurrentBlock => CurrPiece.BlockType;

		public BlockType NextBlock => NextPiece.BlockType;

		public int CurrentBlockRotation => CurrPiece.Rotation;
	}
}
